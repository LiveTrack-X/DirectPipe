...
- AGC defaults: target -15 LUFS (range -24 to -6), low correct 0.50 (boost envelope speed), high correct 0.75 (cut envelope speed), attack 500ms, release 700ms, LUFS window 1.5s, max gain 24 dB, freeze level -45 dBFS (per-block RMS, NOT LUFS), freeze bypassed when < -65 dBFS. K-weighting ITU-R BS.1770 sidechain (copy, not applied to audio). Incremental runningSquareSum_ (O(blockSize) not O(windowSize)). Correction % = envelope speed (NOT gain amount)
