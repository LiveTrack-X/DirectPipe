...
- Google Test 기반 현재 `main` **CTest 490개 등록**: core 59 + host 429 + focused endpoint 2. v4.2.1 릴리즈 당시 실행 결과와 환경 의존 skip 수는 `docs/ReleaseNote.md` 참조 / Current `main` has **490 CTest registrations**: 59 core + 429 host + 2 focused endpoint tests. See `docs/ReleaseNote.md` for the v4.2.1 release-time result and environment-dependent skips.
