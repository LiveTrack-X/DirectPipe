...
// VST version constant (macro so it stays visible outside namespace wrapping)
#ifndef kVstVersion
#define kVstVersion 2400  // VST 2.4
#endif
...
// Extended audioMaster opcodes enum (used by plugin client code)
typedef VstInt32 AudioMasterOpcodesX;
...
enum VstSmpteFrameRate
{
    ...
    kVstSmpteFilm16mm = 14,
    kVstSmpteFilm35mm = 15
};
