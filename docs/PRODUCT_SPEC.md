...
> 역기획서 — v4.2.3 릴리즈 구현을 기준으로 작성
>
> Reverse spec — based on the released v4.2.3 implementation
...
| 버전 / Version | "v4.2.3" (우하단 / bottom-right, 10pt) |
...
│   ├── manifest.json               → SDKVersion 3, 10 액션 / actions, v4.2.3.0
...
│
├── tests/                          → Google Test (core + host + endpoint, current `main`: 492 CTest registrations)
