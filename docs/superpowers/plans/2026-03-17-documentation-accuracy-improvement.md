...
- **High Correct (컷 블렌드)**: 기본 0.90. hold↔full correction 블렌드 비율. 0.0(현재 게인 유지)~1.0(완전 보정)
- **Max Gain (최대 증폭)**: 기본 22 dB. 최대 부스트 한계. 과도한 증폭 방지

**권장 설정 / Recommended Settings:**
- 일반 방송: Target -15, Low 0.50, High 0.90, Max Gain 22 dB
- 조용한 환경: Target -14, Low 0.60, High 0.80, Max Gain 18 dB
- 게임 + 음성: Target -16, Low 0.40, High 0.80, Max Gain 22 dB (게임 소리와 분리)
```
