...
v4.0.7 이후, 방송 전 오디오 테스트나 Full Backup/프리셋 복원 후 오디오 장치가 다시 잡히지 않는 문제를 보강한 핫픽스 릴리스입니다.
This v4.0.8 hotfix hardens Full Backup and preset restore when the audio driver reports a stopped or invalid device state.
